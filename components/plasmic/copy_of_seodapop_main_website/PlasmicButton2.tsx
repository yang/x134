...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: UH_OJS3VRY1S/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: PcxS1M74DaAE/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: UyeoLwV2I9QB/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__dCcRb)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__ymIUy)}
                role={"img"}
              />
            ),
