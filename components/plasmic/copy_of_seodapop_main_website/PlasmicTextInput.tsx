...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: e2KvIfjspOt8/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: pzbvJhnvLIyh/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: PcxS1M74DaAE/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___9Em7M)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__tAeql)}
                role={"img"}
              />
            ),
